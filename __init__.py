...
from .utilities.addon_utils import on_blender_startup, keymap_register, keymap_unregister
from .utilities.thread_utils import timer_update

from . import mcam_ui
from . import mastercam_workspace
from . import mastercam_shortcuts
...
def register() -> None:
    ...
    mastercam_shortcuts.register()


def unregister() -> None:
    mastercam_shortcuts.unregister()
